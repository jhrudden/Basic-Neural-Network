...
def forward_prop(X, params):
    ...
    A = X  # input to the first layer (training data)
    caches = []
    L = len(params) // 2  # params holds both biases and weights for each layer
    for l in range(1, L + 1):
        ...
        # store both linear and activation cache
